...
\begin{itemize}
    ...
    \item \texttt{universal\_compensator}: A universal compensator, also known as universal polarizer, can be used to generate any polarization.\vspace{1em}
    {\large \textbf{7. propagation.py}}
