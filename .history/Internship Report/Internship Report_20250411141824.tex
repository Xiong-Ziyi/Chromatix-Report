...
\begin{titlepage}
    ...
    \vspace{1cm}
    {\LARGE Report on Chromatix}\\[1.5cm]
    {\large Ziyi Xiong}\\[0.2cm]
    ...
    {\large Industry Advisor: Prof. Dr. Frank Wyrowski, President of LightTrans GmbH}\\[2cm]
    \includegraphics[width=0.3\textwidth]{ASP.jpeg} \hfill
    \includegraphics[width=0.3\textwidth]{IAP.jpg}\\[2cm]
    \vfill
\end{titlepage}
