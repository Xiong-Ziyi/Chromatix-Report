...
\begin{titlepage}
    \begin{minipage}[t]{0.45\textwidth}
        \includegraphics[width=0.9\textwidth]{ASP.jpeg}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.45\textwidth}
        \raggedleft
        \includegraphics[width=0.9\textwidth]{IAP.jpg}
    \end{minipage}

    \vspace{2cm}

    {\Huge\centering Internship Report\\[0.5cm]}
    \vspace{0.5cm}

    \raggedright
    \large
    \textbf{Author:} Ziyi Xiong\\[0.5cm]
    \textbf{Internship Topic:} Report on Chromatix\\[0.5cm]
    \textbf{Internship Period:} 01-09-2024 to 28-02-2025\\[0.5cm]
    \textbf{Supervisor:} Prof. Dr. Vladan Blahnik, Institute of Applied Physics\\[0.5cm]
    \textbf{Industry Advisor:} Prof. Dr. Frank Wyrowski, President of LightTrans GmbH\\
