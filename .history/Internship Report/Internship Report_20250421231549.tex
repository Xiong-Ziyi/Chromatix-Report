...
\begin{itemize}
  \item \texttt{OpticalSystem}: Applies an amplitude mask to an incoming Field by calling the function amplitude\_change from the functional package. The amplitude can be learned pixel by pixel.
\end{itemize}
