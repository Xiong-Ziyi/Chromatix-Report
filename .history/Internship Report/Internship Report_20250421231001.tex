...
\begin{itemize}
  ...
  \item \texttt{parse_init}: This is a class built upon the generic\_field function that can be used to generate an electromagnetic field with arbitrary amplitude and phase. Among the attributes, amplitude, phase, and power can be learned.   
\end{itemize}
